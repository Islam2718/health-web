  ...
  return (
    <div>
      ...
      <div className="mx-auto mb-6 max-w-3xl">
        <h1 className="text-2xl font-bold tracking-tight text-foreground">Edit Ambulance</h1>
        <p className="mt-1 text-sm text-muted-foreground">Update vehicle and driver details.</p>
      </div>
      <AmbulanceForm ambulanceId={params.id} />
    </div>
  );
}
